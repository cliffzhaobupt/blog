...
(function($){
  // console.log($.cleditor.buttons.image);
  var $imageBtn = $.cleditor.buttons.image
  $imageBtn.popupName = 'addimage';
  $imageBtn.popupClass = 'cleditorPrompt';
  $imageBtn.popupContent = [
    '画像を選択してください<br/>',
    '<form method="post" class="photo-upload-form" action="/photos/uploadinarticle" enctype="multipart/form-data" method="post">',
    '<input name="photo" type="file"/><br/>',
    '<input type="submit" value="画像をウアプロード"/>',
    '</form>'
  ].join('');
  $imageBtn.buttonClick = addImageClick;

  function addImageClick (e, data) {

    $(data.popup).children('.photo-upload-form')
      .unbind('submit')
      .bind('submit', function (e) {
        e.preventDefault();

        var editor = data.editor,
          fileField = $(this).children('[type=file]');
        if (! fileField.val()) return;
        $(this).ajaxSubmit({
          beforeSend: function () {
          ...
          success: function (dataBack) {
            editor.execCommand(data.command, dataBack.url, null, data.button);
            fileField.val('');
